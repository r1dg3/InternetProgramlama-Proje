<?php 
	...
	function getTable($table_name) {//verilen isimdeki tablodan tum dataları çekip bir diziye yerleştirir.
        ...
        <div class="logo">
	 	...
	 	<div class="row" >
	 		<div class="col-md-10 mx-auto">
	 			<div class="row">
	 				<div class="col-md-10 "> 
		 				<h3 style="margin-top:150px;margin-left: -718px">Hoşgeldin <?php echo "".$_SESSION['name']; ?></h3>
			 		</div>
	 	...
	 	<div class="row">
	 		<div class="col-md-10 mx-auto">
	 			<form class="form-inline" action="" method="POST">
					<label class="my-1 mr-2" for="table_id_select">Projeyi Seçiniz: </label>
									...
									<table class="table table-striped">
									  <thead>
									    <tr>
									      ...
									      <th style="width: 13%" scope="col">Ara Değerlendirme Notu</th>
									      <th style="width: 13%" scope="col">Değerlendirme Notu</th>
